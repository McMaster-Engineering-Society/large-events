# Large Event Platform - Mobile Shell

React Native mobile application shell with authentication and team component integration.

## Overview

The mobile-shell is a React Native + Expo application that provides:
...
3. Mobile-shell imports and uses:
   ```typescript
...
# Or from mobile-shell directory
...
3. **Use TeamComponentProps interface**:
   ```typescript
   import type { TeamComponentProps } from '@large-event/mobile-shell';
